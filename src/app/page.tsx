...
export const metadata = {
  ...
  keywords:
    "credit card, Amazon, product purchasing, online shopping, credit bidding",
};
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <section className="grid md:grid-cols-3 gap-8 mb-20">
          <div className="bg-dark-light bg-opacity-20 p-8 rounded-2xl shadow-xl backdrop-blur-sm">
            <h2 className="text-2xl font-semibold mb-4 text-violet-light">
              Post Your Wishlist
            </h2>
            <p className="text-gray-300">
              Share the Amazon products you want and let credit card holders bid
          ...
          <div className="bg-dark-light bg-opacity-20 p-8 rounded-2xl shadow-xl backdrop-blur-sm">
            ...
            <p className="text-gray-300">
              Our platform ensures safe and secure transactions between buyers
          ...
          <div className="bg-dark-light bg-opacity-20 p-8 rounded-2xl shadow-xl backdrop-blur-sm">
            ...
            <p className="text-gray-300">
              Credit card holders can earn cashback or points while helping
              others get their desired products.
            </p>
          </div>
        </section>
        ...
        <section className="mb-20">
          <h2 className="text-3xl font-bold mb-10 text-center text-violet-light">
            What Our Users Say
          </h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-dark-light bg-opacity-20 p-8 rounded-2xl shadow-xl backdrop-blur-sm">
              <p className="mb-4 text-gray-300">
                &quot;I got my dream gadget without waiting to save up. CredBid
                is a game-changer!&quot;
              </p>
              <p className="font-semibold text-violet-light">
                - Alex S., Happy Shopper
              </p>
            </div>
            <div className="bg-dark-light bg-opacity-20 p-8 rounded-2xl shadow-xl backdrop-blur-sm">
              <p className="mb-4 text-gray-300">
                &quot;I maximized my credit card rewards by helping others.
                It&lsquo;s a win-win!&quot;
              </p>
              <p className="font-semibold text-violet-light">
                - Jamie T., Credit Card Holder
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="text-center">
          <h2 className="text-3xl font-bold mb-6 text-violet-light">
